...
public typealias SNSPayload = GroupedRecords<LambdaExecutionContext, SNSRecordMeta, SNSBodyAttributes>
public typealias SNSHandler = (SNSPayload) throws -> EventLoopFuture<Void>
